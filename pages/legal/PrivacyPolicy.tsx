    ...
    <section className="py-16 bg-slate-900/20 light:bg-slate-50/10 backdrop-blur-sm border-b border-slate-900/50 light:border-slate-200">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="prose prose-lg prose-invert light:prose-slate max-w-none prose-p:text-slate-300 light:prose-p:text-slate-600 prose-headings:text-slate-50 light:prose-headings:text-slate-900">
          ...
          <h2 className="text-2xl font-bold text-slate-50 mt-8 mb-4">1. Information Collection</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-50 mt-8 mb-4">2. Cookies</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-50 mt-8 mb-4">3. Third Parties</h2>
          <p>Our site contains links to other websites. We are not responsible for the privacy practices of those sites.</p>

          <h2 className="text-2xl font-bold text-slate-50 mt-8 mb-4">4. Contact</h2>
