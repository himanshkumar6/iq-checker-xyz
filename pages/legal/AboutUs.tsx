    ...
    <section className="py-16 bg-slate-900/40 light:bg-slate-50/70 backdrop-blur-sm border-b border-slate-900 light:border-slate-200">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 light:text-slate-600 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div className="glass bg-slate-900/40 light:bg-white/60 backdrop-blur-md p-8 rounded-[2rem] border-slate-800 light:border-slate-200">
            ...
            <h2 className="text-2xl font-bold text-slate-50 light:text-slate-900 mb-4">Our Methodology</h2>
          ...
          <div className="glass bg-slate-900/40 light:bg-white/60 backdrop-blur-md p-8 rounded-[2rem] border-slate-800 light:border-slate-200">
            ...
            <h2 className="text-2xl font-bold text-slate-50 light:text-slate-900 mb-4">Privacy & Integrity</h2>
            <p className="text-slate-300 light:text-slate-600 text-sm leading-relaxed mb-4">
        ...
        <div className="prose prose-lg prose-invert light:prose-slate max-w-none mb-20 prose-headings:text-slate-50 light:prose-headings:text-slate-900">
          <h2 className="text-3xl font-black text-slate-50 light:text-slate-900 mb-8 border-b border-slate-800 light:border-slate-200 pb-4">Editorial Integrity & EEAT</h2>
        ...
        <div className="bg-blue-600/5 light:bg-blue-50/50 rounded-[3rem] p-12 text-center border border-blue-600/10 light:border-blue-200">
          ...
          <h2 className="text-3xl font-black text-slate-50 light:text-slate-900 mb-4">Get In Touch</h2>
          <p className="text-slate-300 light:text-slate-600 mb-8">Questions about our methodology or interested in collaboration?</p>
